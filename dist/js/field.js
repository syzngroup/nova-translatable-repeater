...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('index-nova-translatable-repeater', __webpack_require__(4));
    Vue.component('detail-nova-translatable-repeater', __webpack_require__(7));
    Vue.component('form-nova-translatable-repeater', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        allRows: function allRows() {
            var _this = this;

            var allRows = JSON.parse(this.field.value);
            ...
            try {
                for (var _iterator = Object.entries(allRows)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    allRows[locale] = allRows[locale].map(function (row) {
  ...
  return _c(
    ...
    [
      _c(
        ...
        { slot: "value" },
        [
          _vm._l(_vm.field.locales, function(localeName, localeKey) {
            return _c(
              "a",
              {
                key: "a-" + localeKey,
                staticClass:
                  "inline-block font-bold cursor-pointer mr-2 mb-3 animate-text-color select-none",
                class: {
          ...
          _vm._v(" "),
          _vm._l(_vm.allRows, function(localeRows, localeKey) {
            return localeKey === _vm.currentLocale
              ? _c(
                  "div",
                  _vm._l(localeRows, function(row, index) {
                    return _c(
                      "ul",
                      ...
                      _vm._l(row, function(subRow) {
                        return _c(
                          "li",
                          { staticClass: "flex items-top mb-1" },
                          [
                            _c("span", { staticClass: "block w-1/6" }, [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__rows_SubFieldRow_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__rows_SubFieldRow_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__rows_SubFieldRow_vue__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__event_bus__ = __webpack_require__(33);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ...
        SubFieldRow: __WEBPACK_IMPORTED_MODULE_1__rows_SubFieldRow_vue___default.a
    },
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_3__event_bus__["a" /* EventBus */].$on('localeChanged', function (locale) {
    ...
    methods: {
        ...
        setInitialValue: function setInitialValue() {
            ...
            this.$nextTick(function () {
                _this2.allRows = _this2.value ? JSON.parse(_this2.value) : {};
                ...
                try {
                    for (var _iterator = Object.entries(_this2.allRows)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var _ref = _step.value;
                        ...
                        if (_this2.shouldAddInitialRows(locale)) {
                            var count = _this2.field.initial_rows - rows.length;
                            for (var i = 1; i <= count; i++) {
                                _this2.addNewRow(locale);
                            }
                        }
                    }
                } catch (err) {
        ...
        hasReachedMaximumRows: function hasReachedMaximumRows(locale) {
        ...
        shouldAddInitialRows: function shouldAddInitialRows(locale) {
            return this.field.initial_rows && this.field.initial_rows > this.allRows[locale].length;
        },
        addNewRow: function addNewRow(locale) {
            if (!this.hasReachedMaximumRows(locale)) {
                ...
                try {
                    for (var _iterator2 = Object.values(this.allRows)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                        var rows = _step2.value;
        ...
        deleteRow: function deleteRow(index, locale) {
            var _iteratorNormalCompletion3 = true;
            var _didIteratorError3 = false;
            var _iteratorError3 = undefined;

            try {
                for (var _iterator3 = Object.values(this.allRows)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        changeTab: function changeTab(locale, dontEmit) {
            if (this.currentLocale !== locale) {
                if (!dontEmit) {
                    __WEBPACK_IMPORTED_MODULE_3__event_bus__["a" /* EventBus */].$emit('localeChanged', locale);
                }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sub_fields_TextSubField_vue__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sub_fields_EmailSubField_vue__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sub_fields_NumberSubField_vue__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sub_fields_SelectSubField_vue__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sub_fields_TextareaSubField_vue__ = __webpack_require__(28);
              ...
              return localeKey === _vm.currentLocale
                ? _c(
                    "draggable",
                    {
                      ...
                      model: {
                        value: _vm.allRows[localeKey],
                        callback: function($$v) {
                          _vm.$set(_vm.allRows, localeKey, $$v)
                        },
                        expression: "allRows[localeKey]"
                      }
                    },
                    _vm._l(localeRows, function(row, index) {
                      return _c("sub-field-row", {
                        ...
                        on: {
                          "delete-row": function($event) {
                            return _vm.deleteRow(index, _vm.currentLocale)
                          }
                        },
                        model: {
                          value: localeRows[index],
                          callback: function($$v) {
                            _vm.$set(localeRows, index, $$v)
                          },
                          expression: "localeRows[index]"
                        }
                      })
                    }),
                    1
          ...
          _c("button", {
            ...
            on: {
              click: function($event) {
                ...
                return _vm.addNewRow(_vm.currentLocale)
              }
            }
          }),
          _vm._v(" "),
